...
def parse_args():
    ...
    parser.add_argument('--ngpu', type=int, default=1, help='GPU number')
    ...
    parser.add_argument('--pkl-path', type=str, default='./result/sirstaug/2022-05-02_14-33-07_agpcnet_1/checkpoint/Iter-36770_mIoU-0.7495_fmeasure-0.8568.pkl',
                        help='checkpoint path')
    #
    # Net parameters
    #
    parser.add_argument('--net-name', type=str, default='transnet_1',
                        help='net name: fcn')
...
class Trainer(object):
    def __init__(self, args):
        ...
        # self.net = torch.load(args.pkl_path, map_location=torch.device('cuda'))
        # for name,param in self.net.named_parameters():
        #     if "head.block" in name:
        ...
        self.save_folder = osp.join('result/','sirstaug',folder_name)
