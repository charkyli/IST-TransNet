...
def parse_args():
    ...
    # Setting parameters
    #
    parser = ArgumentParser(description='Inference of IST-TransNet')
    ...
    parser.add_argument('--image-path', type=str, default=r'./hardDet/sky/04303.jpg', help='image path')
...
if __name__ == '__main__':
    ...
    # outpic = cv2.resize(img,(256,256))
    # plt.imsave('./outpic.png',outpic)
    ...
    plt.xticks([])
    plt.yticks([])
    plt.savefig(r'./hardDet/skyTarget/04303.jpg',bbox_inches='tight')